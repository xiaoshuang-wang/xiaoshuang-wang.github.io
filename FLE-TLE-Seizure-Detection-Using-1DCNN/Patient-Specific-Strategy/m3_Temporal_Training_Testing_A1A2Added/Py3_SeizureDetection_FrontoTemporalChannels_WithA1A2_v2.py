...
Path = 'D:/03_EpilepsyData/02_DataSelectedProcessing/m3_Temporal_Training_Testing_A1A2Added/' ###
...
for FoldersNum in range(0,NumFolder):
    ...
    NewPath = Path+'DetectionLabels_v2/'+'03_FrontoTemporalChannels_WithA1A2/'+Folders[FoldersNum] #############################
    ...
    for MatNum in range(0,NumMat):
        ...
        Train = TempTrain[:,:,np.r_[0:4,10:19]]
        del TempTrain
        gc.collect()

...
Path = 'D:/03_EpilepsyData/03_SeizureDetection/m0_Temporal_TrainingTesting/0.5Overlap/' ###
mat_files = [f for f in os.listdir(Path) if f.endswith('.mat')]
NumMat = len(mat_files)
NumRun = 5

NewPath = Path+'DetectionLabels_Again/'+'03_TemporalChannels/' #############################

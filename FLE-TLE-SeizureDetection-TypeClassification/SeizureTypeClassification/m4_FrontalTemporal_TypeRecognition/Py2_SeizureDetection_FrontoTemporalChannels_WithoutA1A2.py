...
Path = 'D:/03_EpilepsyData/04_SeizureTypeRecognition/m2_FrontalTemporal_TypeRecognition/0.5Overlap/' ###
mat_files = [f for f in os.listdir(Path) if f.endswith('.mat')]
NumMat = len(mat_files)
NumRun = 5

NewPath = Path+'DetectionLabels_Again/'+'02_FrontoTemporalChannels_WithoutA1A2/' #############################
